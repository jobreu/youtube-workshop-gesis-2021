...
```{block, opts.label = "clues"}
You can find the quota calculator [here](https://developers.google.com/youtube/v3/determine_quota_cost) and look for the right resource and method. The quota cost of **one** such call is displayed on the right side.
```
```{block, solution = TRUE}
